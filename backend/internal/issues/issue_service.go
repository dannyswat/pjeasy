...
func (s *IssueService) GetIssuesByAssignee(projectID int, userID int, limit int, excludeStatuses []string) ([]Issue, error) {
	return s.issueRepo.GetByProjectAndAssigneeLimited(projectID, userID, limit, excludeStatuses)
}
