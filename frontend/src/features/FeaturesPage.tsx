      ...
      <div className="mb-4 flex items-center space-x-3">
        ...
        <div className="relative" ref={statusDropdownRef}>
          <button
            ...
            className="px-3 py-1.5 text-sm border border-gray-300 rounded bg-white hover:bg-gray-50 focus:ring-2 focus:ring-green-500 focus:border-transparent min-w-30 text-left flex items-center justify-between"
          >
            <span>
